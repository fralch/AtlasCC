...
const Nosotros = () => {
    return (
        <div className='bg-[url("/img/FONDOS/about.png")] bg-cover bg-center bg-no-repeat bg-[#004aaf] p-4'>
            <h1 className='text-[#38b5ff]  text-7xl ml-44 mt-20'>Sobre <span>Nosotros</span></h1>
            ...
            <div className='flex flex-row items-center ml-40'>
                ...
                <div className="relative inline-block">
                    <img src="/img/nosotros.png" alt="" className="m-0 relative z-10 drop-shadow-[3px_5px_50px_rgba(255,255,255,0.9)]" />
                </div>
            </div>
        </div>
    );
